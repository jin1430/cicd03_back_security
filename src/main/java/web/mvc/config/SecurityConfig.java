        ...
        http.cors((corsCustomizer ->
                corsCustomizer.configurationSource(new CorsConfigurationSource()
                {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        configuration.setAllowedOrigins(Arrays.asList("http://13.209.8.130", "http://13.209.8.130:80"));
                        //configuration.setAllowedOrigins(Arrays.asList("http://lastyou.o-r.kr", "https://lastyou.o-r.kr"));
